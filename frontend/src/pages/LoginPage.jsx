...
import SocialLogin from '../components/auth/SocialLogin';
import Logo from '../components/Logo';
import { toast } from 'react-hot-toast'; // Thêm thư viện hiển thị thông báo
...
const LoginPage = () => {
    ...
    // Hàm xử lý thông báo bảo trì
    const handleMaintenance = (featureName) => {
        toast(`Tính năng ${featureName} đang tạm thời bảo trì!`, {
            icon: '🚧',
            style: {
                borderRadius: '10px',
                background: '#333',
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-vintage border border-vintage-gold/20 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {/* ĐÃ SỬA: Thay Link thành Button gọi thông báo */}
                            <button 
                                type="button"
                                onClick={() => handleMaintenance('Quên mật khẩu')}
                                className="text-sm text-vintage-gold hover:text-vintage-bronze dark:hover:text-vintage-bronze" 
                                style={{ fontFamily: 'Arial, sans-serif' }}
                            >
                                Quên mật khẩu?
                            </button>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-vintage-darkwood dark:text-vintage-cream" style={{ fontFamily: 'Arial, sans-serif' }}>
                            ...
                            <button 
                                type="button"
                                onClick={() => handleMaintenance('Đăng ký')}
                                className="text-vintage-gold hover:text-vintage-bronze font-medium" 
                                style={{ fontFamily: 'Arial, sans-serif' }}
                            >
                                Đăng ký ngay
                            </button>
